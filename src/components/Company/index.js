...
const Company = ({
  ...
  const totalIncome =
    Number(company.subsidiary.reduce((sum, curr) => sum + curr.income, 0)) +
...
const mapDispatchToProps = (dispatch) => ({
  ...
  editSubsidiary: (editedSubsidiary) =>
    dispatch(editSubsidiary(editedSubsidiary)),
